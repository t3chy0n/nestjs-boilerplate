...
//     return Observable.fromPromise(this.channel.close());
//   }
//
//   /**
...
//     return Observable.fromPromise<Replies.AssertQueue>(
...
//     return Observable.fromPromise<Replies.DeleteQueue>(
//       this.channel.deleteQueue(queue, options),
...
//     return Observable.fromPromise<Replies.PurgeQueue>(
...
//   ): Observable<EmptyReply> {
//     return Observable.of(
//       this.channel.unbindQueue(queue, source, pattern, args),
//     ).map(() => new EmptyReply(this));
//   }
//
//   /**
...
//     return Observable.fromPromise<Replies.AssertExchange>(
...
//     return Observable.fromPromise(this.channel.checkExchange(exchange)).map(
//       (reply) => new EmptyReply(this),
//     );
//   }
//
//   /**
...
//       this.channel.deleteExchange(exchange, options),
...
//       cb: any,
//     ) => {
//       this.channel.publish(_e, _r, _b, _o, cb);
//     };
//     const bound = Observable.bindNodeCallback(func);
//     return bound(exchange, routingKey, content, options);
//   }
//
//   /**
...
//     return Observable.create((observer: Rx.Observer<any>) => {
//       let tag: string;
//       const close$ = Observable.fromEvent(this.channel, 'close');
...
//     return Observable.fromPromise(this.channel.cancel(consumerTag)).map(
//       (reply) => new EmptyReply(this),
//     );
//   }
//
...
//     return Observable.fromPromise<boolean | Message>(
...
//     return Observable.fromPromise(this.channel.prefetch(count, global)).map(
//       (reply) => new EmptyReply(this),
//     );
//   }
//
...
//     return Observable.fromPromise(this.channel.recover()).map(
//       (reply) => new EmptyReply(this),
//     );
//   }
// }
//
// export default RxConfirmChannel;
